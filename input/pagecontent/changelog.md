...
|[FHIR-56280](https://jira.hl7.org/browse/FHIR-56280)|Generalize from FHIR server to resource server and from FHIR resources to protected resources|
...
|[FHIR-57236](https://jira.hl7.org/browse/FHIR-57236)|Add references to Section 7.2 scope negotiation rules from related workflow guidance|
...
|[FHIR-56280](https://jira.hl7.org/browse/FHIR-56280)|Clarify that Protected Resources on a Resource Server are what is being protected, where FHIR Server is an example of a Resource Server|
